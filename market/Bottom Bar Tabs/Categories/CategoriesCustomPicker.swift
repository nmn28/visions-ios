...
extension CGFloat {
    func categoriesinterpolate(inputRange: [CGFloat], outputRange: [CGFloat]) -> CGFloat {
...
extension View {
    func categoriesrect(completion: @escaping (CGRect) -> ()) -> some View {
        self
            .overlay {
                GeometryReader {
                    ...
                    Color.clear
                        .preference(key: categoriesRectKey.self, value: rect)
                        .onPreferenceChange(categoriesRectKey.self, perform: completion)
                }
            }
    }
}

struct categoriesRectKey: PreferenceKey {
...
struct CategoriesTabModel: Identifiable {
...
struct CategoriesCustomTabBar: View {
    @Binding var tabs: [CategoriesTabModel]
    @Binding var activeTabIndex: Int
    @Binding var tabBarScrollState: CategoriesTabModel.Tab?
    @Binding var mainViewScrollState: CategoriesTabModel.Tab?
...
struct CategoriesTab: Identifiable, Hashable {
    var id: UUID = UUID()
    var title: String?
    ...
    static var sampleTabs: [CategoriesTab] = [
        .init(title: "MyFettle"),
        .init(title: "MyFettle"),
        .init(title: "MyFettle"),
        .init(title: "MyFettle"),
...
struct CategoriesCustomToolbar: View {
...
struct CategoriesTabView: View {
    ...
    @Binding var indicatorWidth: CGFloat
    @Binding var indicatorPosition: CGFloat
    let onSwipe: (CategoriesSwipeDirection) -> Void
    ...
    func updateTabFrame(_ tabViewWidth: CGFloat) {
        ...
        let widthInterpolation = CategoriesLinearInterpolation(inputRange: inputRange, outputRange: outputRangeForWidth)
        let positionInterpolation = CategoriesLinearInterpolation(inputRange: inputRange, outputRange: outputRangeForPosition)
    ...
    func index(of tab: CategoriesTabModel) -> Int {
...
//                            .environmentObject(HealthManager())
        ...
        .overlay(
            GeometryReader { geometry in
                Color.clear
                    .preference(key: categoriesRectKey.self, value: geometry.frame(in: .global))
                    .onPreferenceChange(categoriesRectKey.self) { value in
                        geometryFrame = value
...
class CategoriesLinearInterpolation {
...
struct CategoriesCustomPicker: View {
    @StateObject var viewModel: MainViewModel // Change this to ObservedObject
    @Binding var isOpened: Bool
    @State private var tabs: [CategoriesTabModel] = [
        .init(id: .research), // 0
    ...
    @State private var activeTab: CategoriesTabModel.Tab = .research    // Below line must match
    @State private var activeTabIndex = 0                           // Above line must match
    @State private var tabBarScrollState: CategoriesTabModel.Tab?
    @State private var mainViewScrollState: CategoriesTabModel.Tab?
    @State private var progress: CGFloat = .zero
    @State private var indicatorWidth: CGFloat =  0.0
    @State private var indicatorPosition: CGFloat = 0.0
    @State private var showCalendar: Bool = false
    @State private var currentCategory: CategoryCategory = .foryou
    ...
    var body: some View {
        VStack(spacing: 0) {
            if isToolbarVisible {
                CategoriesCustomToolbar(viewModel: viewModel,
                                    isOpened: $isOpened,
            ...
            CategoriesCustomTabBar(tabs: $tabs,
...
struct CategoriesListView: View {
    ...
    @State private var swipeDirection: CategoriesSwipeDirection = .none
    @State private var prevDirection: CategoriesSwipeDirection = .none
    @State private var prevPrevDirection: CategoriesSwipeDirection = .none
...
enum CategoryCategory: String, CaseIterable {
    case foryou = "For You"
...
extension View {
    func CategoriesoffsetX(completion: @escaping (CGRect) -> ()) -> some View {
        self
            .overlay {
                GeometryReader { proxy in
                    ...
                    Color.clear
                        .preference(key: CategoriespickerOffsetKey.self, value: rect)
                        .onPreferenceChange(CategoriespickerOffsetKey.self, perform: completion)
                }
            }
    }
    
    func CategoriesdetectSwipe(onSwipe: @escaping (CategoriesSwipeDirection) -> ()) -> some View {
        self
            .gesture(
                DragGesture()
                    .onChanged { value in
...
struct CategoriespickerOffsetKey: PreferenceKey {
    static var defaultValue: CGRect = .zero
...
struct CategoriesCustomPicker_Previews: PreviewProvider {
    static var previews: some View {
        CategoriesCustomPicker(viewModel: MainViewModel(), isOpened: .constant(false))
    }
}
...
//            },
//            centerContent: {
//                AnyView(Text("Categories").font(.headline))
//            },
//            rightContent: {
//                AnyView(HStack(spacing: 20) {
////                    Button(action: {
...
//
//struct CategoriesTabView: View {
//    @Binding var tabs: [CategoriesTab]
//    @Binding var currentTab: CategoriesTab
//    @Binding var indicatorWidth: CGFloat
//    @Binding var indicatorPosition: CGFloat
//    let onSwipe: (CategoriesSwipeDirection) -> Void
//    
...
//    }
//    
//    func index(of tab: CategoriesTab) -> Int {
...
//}
//
//struct CategoriesTabsView: View {
//    @Binding var tabs: [CategoriesTab]
//    @Binding var currentTab: CategoriesTab
//    @Binding var indicatorWidth: CGFloat
//    @Binding var indicatorPosition: CGFloat
...
//}
//
//enum CategoriesCategory: String, CaseIterable {
//    case foryou = "For You"
//    case following = "Following"
//    case recent = "Most Recent"
//
...
//
//struct CategoriesCustomPicker: View {
//    @State private var currentTab = CategoriesTab.sampleTabs[0]
//    @State private var tabs = CategoriesTab.sampleTabs
//    @State private var isToolbarVisible = true
//    @State private var indicatorWidth: CGFloat =  0.0
//    @State private var indicatorPosition: CGFloat = 0.0
...
//    
//    @State private var showCalendar: Bool = false
//    @State private var currentCategory: CategoriesCategory = .foryou
//    
//    func action1() {
//        print("Action 1 selected")
//    }
...
//        VStack(spacing: 0) {
//            if isToolbarVisible {
//                CategoriesCustomToolbar(showCalendar: $showCalendar)
//                    .padding(.bottom, 10)
//            }
//            
//            
//            if showCalendar {
//                
//                MainCalendarView(text: MainCalendarView.$searchText, onSearchChanged: { _ in }) // Adjust according to actual requirements
//                    .transition(.move(edge: .top)) // Optional: Add transition for better UI experience
//                    .animation(.default, value: showCalendar) // Optional: Animate the appearance/disappearance
//            }
//            
...
//                    ForEach(CategoriesCategory.allCases, id: \.self) { category in
//                        HStack {
