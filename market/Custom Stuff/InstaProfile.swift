                ...
                LazyVStack(pinnedViews: [.sectionHeaders]){
                    ...
                    Section(header:
                                ...
                                HStack(spacing: 0){
                                    ...
                                    InstaTabBarButton(image: "square.grid.3x3", isSystemImage: true, animation: animation, selectedTab: $selectedTab)
                                    
                                    InstaTabBarButton(image: "reels", isSystemImage: false, animation: animation, selectedTab: $selectedTab)
                                    
                                    InstaTabBarButton(image: "person.crop.square", isSystemImage: true, animation: animation, selectedTab: $selectedTab)
                                }
                                // Max Frame....
...
struct InstaProfile_Previews: PreviewProvider {
    static var previews: some View {
        InstaProfile()
    }
}

struct InstaTabBarButton: View {
