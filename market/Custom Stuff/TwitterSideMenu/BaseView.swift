...
//  market
//
//  Created by Nicholas Nelson on 3/28/24.
//
...
struct BaseView: View {
    ...
    var body: some View {
        ...
        let sideBarWidth = getmenuRect().width - 90
        ...
        NavigationView{
            ...
            HStack(spacing: 0){
                ...
                // Side Menu...
                TwitterSideMenu(showMenu: $showMenu)
            ...
            // max Size...
            .frame(width: getmenuRect().width + sideBarWidth)
