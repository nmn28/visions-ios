...
//  market
//
//  Created by Nicholas Nelson on 3/29/24.
//
...
//     static var sampleTabs: [CustomTab] = [
//         .init(iconName: "globe"),
...
//}
//
//struct CustomCustomToolbar: View {
...
//class CustomLinearInterpolation {
...
//        VStack(spacing: 0) {
//            if isToolbarVisible {
//                WatchlistsCustomToolbar(isOpened: $isOpened, showCalendar: $showCalendar)
//                    .padding(.bottom, 10)
//            }
//            
//            
//            if showCalendar {
//                
//                MainCalendarView(isOpened: .constant(true)) // Adjust according to actual requirements
...
//
//#Preview {
//    WatchlistsCustomPicker(isOpened: .constant(false))
//}
