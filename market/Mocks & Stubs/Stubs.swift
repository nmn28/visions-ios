...
extension Idea {
    ...
    static var stubs: [Idea] {
        [
            Idea(symbol: "AAPL", shortname: "Apple Inc.", exchDisp: "NASDAQ"),
            Idea(symbol: "TSLA", shortname: "Tesla."),
            Idea(symbol: "NVDA", shortname: "Nvidia Corp."),
            Idea(symbol: "AMD", shortname: "Advanced Micro Device")
        ]
    }
    
    static var stub: Idea {
        stubs[0]
    }
