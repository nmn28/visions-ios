...
// Preview Provider
struct AnimatedSideBar_Previews: PreviewProvider {
    static var previews: some View {
        AnimatedSideBar(
            showMenu: .constant(true),
            content: { _ in MockContentView() },
            menuView: { _ in MockMenuView() },
            background: { Color.red.opacity(0.3) } // Adjusted to use a closure that returns a View
        )
